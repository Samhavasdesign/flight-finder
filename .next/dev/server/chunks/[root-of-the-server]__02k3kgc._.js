...
"[project]/Flight-app/flight-finder/src/lib/deals/logRun.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Flight-app/flight-finder/node_modules/@supabase/supabase-js/dist/index.mjs [app-route] (ecmascript) <locals>");
;
async function logRun(deals, errors) {
    const supabaseUrl = process.env.SUPABASE_URL;
    const supabaseAnonKey = process.env.SUPABASE_ANON_KEY;
    if (!supabaseUrl || !supabaseAnonKey) {
    ...
    try {
        if (dealEntries.length > 0) {
            const dealRows = dealEntries.flatMap(([, originDeals])=>originDeals.map((deal)=>({
    ...
    try {
        if (dealEntries.length > 0) {
            const uniqueDestinations = new Set(dealEntries.flatMap(([, originDeals])=>originDeals.map((deal)=>deal.hubFare.destination)));
            const dedupRows = [
                ...uniqueDestinations
            ].map((destination)=>({
            ...
            const { error } = await supabase.from("dedup_index").upsert(dedupRows, {
...
"[project]/Flight-app/flight-finder/src/app/api/deals/cron/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$src$2f$lib$2f$deals$2f$logRun$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Flight-app/flight-finder/src/lib/deals/logRun.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
async function GET() {
    ...
    const departure = new Date(startedAt);
    ...
    let fares = await Promise.resolve([]);
    try {
        fares = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$src$2f$lib$2f$deals$2f$fetchFares$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFaresForHubs"])(hubs, departureDate, returnDate);
    } catch (error) {
    ...
    let deals = await Promise.resolve({});
    try {
        deals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$src$2f$lib$2f$deals$2f$scoreAndFilter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scoreAndFilter"])(fares);
    } catch (error) {
        console.error("[cron] Failed to score/filter deals:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to score and filter deals"
        }, {
            status: 500
        });
    }
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$src$2f$lib$2f$deals$2f$sendDigest$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendDigest"])(deduplicatedDeals);
    } catch (error) {
        console.error("[cron] Failed to send digest:", error);
    }
    const errors = [];
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Flight$2d$app$2f$flight$2d$finder$2f$src$2f$lib$2f$deals$2f$logRun$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logRun"])(deduplicatedDeals, errors);
    const dealsFound = Object.keys(deduplicatedDeals).length;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02k3kgc._.js.map